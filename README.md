...
Sumber Data:
1. Curah Hujan: BMKG (data harian tahun 2024)
2. Inflasi: BPS (per provinsi, subkelompok makanan, minuman, dan tembakau, tahun 2024)
3. Harga Bahan Pokok: PIHPS (data harian → diolah menjadi bulanan per komoditas)
...
1. Dataset final sudah siap digunakan untuk analisis regresi berganda.
2. Sudah ditemukan insight awal mengenai hubungan curah hujan, inflasi, dan harga bahan pokok.
3. EDA memberikan gambaran pola tren dan hubungan antarvariabel.
